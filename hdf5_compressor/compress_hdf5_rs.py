...
def load_hdf5(dataset_path):
    ...
    return is_sim, qpos, qvel, effort, action, image_dict, sound_dict
...
def save_hdf5(file_info):
    ...
    try:
        is_sim, qpos, qvel, effort, action, image_dict, sound_dict = load_hdf5(episode_path)
        ...
        with h5py.File(out_path, 'w', rdcc_nbytes=1024**2*2) as root:
            ...
            for cam_name in CAMERA_NAMES+CAMERA_NAMES:
                if is_compress:
